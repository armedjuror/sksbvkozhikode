              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                     <label class="control-label col-sm-2" for="activesbv">Whether SKSBV is active in your unit ?</label>
                     <div class="col-sm-10">
                   ...
                   <div class="form-group">
                     ...
                     if (isset($_POST['update'])) {
                       ...
                       $sql="UPDATE units SET units.stno='$stno',units.mads='$mads',units.activesbv='$activesbv' WHERE units.unit='$unit'";
