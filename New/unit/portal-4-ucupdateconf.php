 ...
 <div class="container">
   ...
   <div class="row">
     ...
     if (isset($_POST['proceed'])) {
       ...
       $vpre3_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$vpre3id'&&members.unit='$unit'");
       $vpre3=mysqli_fetch_array($vpre3_query);
       if (mysqli_num_rows($vpre3_query)==0) {
       echo "<script>
       alert('ID ($vpre3id) does not exists or does not belongs to your unit.');
       window.location.href='portal-4-ucupdate.php';
       </script>";
       }
       ...
       $jsec3_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$jsec3id'&&members.unit='$unit'");
       $jsec3=mysqli_fetch_array($jsec3_query);
       if (mysqli_num_rows($jsec3_query)==0) {
       echo "<script>
       alert('ID ($jsec3id) does not exists or does not belongs to your unit.');
       window.location.href='portal-4-ucupdate.php';
       window.
       </script>";
       }
