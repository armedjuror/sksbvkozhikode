   ...
   <div class="row">
     <div class="col-*-*">
       <div class="panel panel-default">
        ...
        <div class="panel panel-default">
         <div class="panel-heading">Sadr Muallim</div>
         <div class="panel-body">
           <form class="form-horizontal">
             
              <div class="form-group">
                 <label class="control-label col-sm-2" for="sadr">Name:</label>
                 <div class="col-sm-10">
                   <input type="text" class="form-control" value="<?php echo $row['sadr'];?>" name="sadr" readonly>
                 </div>
               </div>
               <div class="form-group">
                  <label class="control-label col-sm-2" for="sadrads">Address:</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" name="sadrads" readonly><?php echo $row['sadrads'];?></textarea>
                  </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-sm-2" for="sadrmob">Mobile:</label>
                   <div class="col-sm-10">
                     <input type="text" class="form-control" value="<?php echo $row['sadrmob'];?>" name="sadrmob" readonly>
                   </div>
                 </div>
           </form>
