        ...
        <ul class="nav navbar-nav">
         ...
         <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Range Committee<span class="caret"></span></a>
           <ul class="dropdown-menu">
             ...
             <li class="active"><a href="portal-6-rupdate.php">Update range profile</a></li>
  ...
  <div class="row">
    <div class="col-*-*">
      <div class="panel panel-default">
        <div class="panel-heading">Update range profile</div>
          ...
          <form class="form-horizontal" action=# method="post">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                 <label class="control-label col-sm-2" for="skjmno">Range SKJM Register Number:</label>
                 <div class="col-sm-10">
                   <input type="text" class="form-control" placeholder="skjmno" name="skjmno">
                 </div>
               </div>
              <div class="form-group">
                 <label class="control-label col-sm-2" for="unno">Number of units:</label>
                 <div class="col-sm-10">
                   <input type="text" class="form-control" placeholder="Number of units" name="unno">
                 </div>
               </div>
               <div class="form-group">
                  <label class="control-label col-sm-2" for="oads">Office Address:</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" placeholder="Office Address" name="oads"></textarea>
                  </div>
                </div>
                 <div class="form-group">
                    <label class="control-label col-sm-2" for="activesbv">Whether SKSBV is active in your range ?</label>
                    <div class="col-sm-10">
                      <input type="radio" value=Yes name="activesbv">Yes<br><br><input type="radio" value=No name="activesbv">No
                  ...
                  <div class="form-group">
                    ...
                    if (isset($_POST['update'])) {
                      ...
                      $oads=$_POST['oads'];
                      $skjmno=$_POST['skjmno'];
                      $activesbv=$_POST['activesbv'];

                      $sql="UPDATE rtadetails SET rtadetails.skjmno='$skjmno',rtadetails.unno='$unno',rtadetails.oads='$oads',rtadetails.activesbv='$activesbv' WHERE rtadetails.username='$username'";
                      if ($con->query($sql)===TRUE) {
                           echo "<script>
                           alert('$range profile updated successfully!');
