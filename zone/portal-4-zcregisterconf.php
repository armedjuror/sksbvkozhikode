    ...
    <div class="container">
      ...
      <div class="row">
        ...
        if (isset($_POST['proceed'])) {
          ...
          $pre_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$preid'&&members.zone='$zone'");
          $pre=mysqli_fetch_array($pre_query);
          if (mysqli_num_rows($pre_query)==0) {
          echo "<script>
          alert('ID ($preid) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          </script>";
          }

          $sec_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$secid'&&members.zone='$zone'");
          $sec=mysqli_fetch_array($sec_query);
          if (mysqli_num_rows($sec_query)==0) {
          echo "<script>
          alert('ID ($secid) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          </script>";
          }

          $tres_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$tresid'&&members.zone='$zone'");
          $tres=mysqli_fetch_array($tres_query);
          if (mysqli_num_rows($tres_query)==0) {
          echo "<script>
          alert('ID ($tresid) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          </script>";
          }

          $vpre1_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$vpre1id'&&members.zone='$zone'");
          $vpre1=mysqli_fetch_array($vpre1_query);
          if (mysqli_num_rows($vpre1_query)==0) {
          echo "<script>
          alert('ID ($vpre1id) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          </script>";
          }

          $vpre2_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$vpre2id'&&members.zone='$zone'");
          $vpre2=mysqli_fetch_array($vpre2_query);
          if (mysqli_num_rows($vpre2_query)==0) {
          echo "<script>
          alert('ID ($vpre2id) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          </script>";
          }

          $vpre3_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$vpre3id'&&members.zone='$zone'");
          $vpre3=mysqli_fetch_array($vpre3_query);
          if (mysqli_num_rows($vpre3_query)==0) {
          echo "<script>
          alert('ID ($vpre3id) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          </script>";
          }

          $jsec1_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$jsec1id'&&members.zone='$zone'");
          $jsec1=mysqli_fetch_array($jsec1_query);
          if (mysqli_num_rows($jsec1_query)==0) {
          echo "<script>
          alert('ID ($jsec1id) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          </script>";
          }

          $jsec2_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$jsec2id'&&members.zone='$zone'");
          $jsec2=mysqli_fetch_array($jsec2_query);
          if (mysqli_num_rows($jsec2_query)==0) {
          echo "<script>
          alert('ID ($jsec2id) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          </script>";
          }

          $jsec3_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$jsec3id'&&members.zone='$zone'");
          $jsec3=mysqli_fetch_array($jsec3_query);
          if (mysqli_num_rows($jsec3_query)==0) {
          echo "<script>
          alert('ID ($jsec3id) does not exists or does not belongs to your zone.');
          window.location.href='portal-4-rcupdate.php';
          window.
          </script>";
          }

          $coun_query=mysqli_query($con,"SELECT * FROM members WHERE members.id='$counid'&&members.zone='$zone'");
          $coun=mysqli_fetch_array($coun_query);
        if (mysqli_num_rows($coun_query)==0) {
        echo "<script>
        alert('ID ($counid) does not exists or does not belongs to your zone.');
        window.location.href='portal-4-rcupdate.php';
        </script>";
        }
        }
                  ...
                  <div class="form-group" name=button_validation>
                    <center>
                      ...
                      if (isset($_POST['register'])) {
                        ...
                        $sq="INSERT INTO zcdetails VALUES ('$zone','$preid',
                          ...
                          if ($con->query($sq) == TRUE) {
                            echo "<script>
                            alert('$zone Zone Committee Successfully Registered !');
                            window.location.href='portal-2-zcoverview.php';
                            </script>";
                          }if ($con->query($sq) == FALSE) {
                            echo "<script>
                            alert('$zone Zone Committee already Registered !');
